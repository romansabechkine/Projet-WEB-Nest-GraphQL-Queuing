    ...
    RedisPubSub.prototype.publish = function (trigger, payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.serializer) return [3, 2];
                        return [4, this.redisPublisher.publish(trigger, this.serializer(payload))];
                    case 1:
                        _a.sent();
                        return [3, 6];
                    case 2:
                        if (!(payload instanceof Buffer)) return [3, 4];
                        return [4, this.redisPublisher.publish(trigger, payload)];
                    case 3:
                        _a.sent();
                        return [3, 6];
                    case 4: return [4, this.redisPublisher.publish(trigger, JSON.stringify(payload))];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [2];
    ...
    RedisPubSub.prototype.onMessage = function (pattern, channel, message) {
        ...
        try {
            if (this.deserializer) {
                parsedMessage = this.deserializer(Buffer.from(message), { pattern: pattern, channel: channel });
            }
